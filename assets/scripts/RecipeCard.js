class RecipeCard extends HTMLElement {
  ...
  set data(data) {
    ...
    //p1.textContent = searchForKey(data, 'headline');
    //p1.setAttribute('innerHTML', searchForKey(data, 'headline'));
    card.appendChild(p1);

    
    let a1 = document.createElement('a');
    //a1.href = searchForKey(data, 'url');
    ...
    let avg_rating = document.createElement('span');
    let check_rating = searchForKey(data, "aggregateRating");
    ...
    //p3.className='recipeIngredient';
    p3.setAttribute('class', 'ingredients');
    card.appendChild(p3);

    var text = searchForKey(data, 'recipeIngredient');
    text = createIngredientList(text);
    let recipe_text = document.createElement('p');
    //recipe_text.innerHTML = text;
    //recipe_text.setAttribute('innerHTML', text);
    recipe_text.textContent = text;
    p3.appendChild(recipe_text);
